            ...
            <div className="w-full sm:w-96 h-96 mb-4 overflow-hidden rounded-lg">
                ...
                <div className="mt-3 flex items-center px-2">
                    ...
                    <div className="flex justify-end grow shrink-0">
                        <Link className="border border-gray-700 rounded-lg font-bold text-sm flex justify-center items-center py-1.5 px-4 shadow-sm bg-white hover:bg-gray-100">
                            Live Demo
                            <div className="w-2 h-2 ms-2 bg-strongRed rounded-full flicker-animation"></div>
                        </Link>
                    </div>
                </div>
                {/* Tags */}
                <div className="flex mt-3 px-2">
                    <p className="bg-primaryBlue rounded-full py-1.5 px-4 text-white me-2 text-sm shadow">#Web</p>
                    <p className="bg-primaryBlue rounded-full py-1.5 px-4 text-white me-2 text-sm shadow">#Development</p>
                </div>
                {/* Choose button */}
